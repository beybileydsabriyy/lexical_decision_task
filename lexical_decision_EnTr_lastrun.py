...
expName = 'lexical_decision_EnTr'  # from the Builder filename that created this script
expVersion = ''
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\asude\\Documents\\lexical task\\lexical_decision_EnTr_lastrun.py',
